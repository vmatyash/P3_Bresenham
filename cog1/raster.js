...
define(["exports", "shader", "framebuffer", "data", "glMatrix"], function ( //
  ...
  function assembleIntersectionForScanline(
    ...
    for (var v = 0; v < polygon.length; v++) {
      ...
      if (texture != null) {
        ...
        var edgeEndTextureCoord =
          textureCoord[polygonTextureCoord[nextVertexIndex]];
      }
  ...
  function scanlineFillPolygon(
    ...
    for (var y = 0; y < scanlineIntersection.length; y++) {
      ...
      if (
        scanlineIntersection[y].length < 2 ||
        scanlineIntersection[y].length % 2
      ) {
        console.log(
          "Error in number of intersections: " + scanlineIntersection[y].length
        );
      }

      //loop over intersectiuon in pairs of 2
